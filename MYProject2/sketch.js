...
class DownroadRoom extends PNGRoom {
  preload() {
    this.tshirt = new StaticSprite("tshirt", 600,200,'assets/shirt.png');
    this.isSetup = false;
...
class BottomLeftRoom extends PNGRoom {
  preload() {
    ...
    //this.button = new StaticSprite("button", 200,200,'assets/button.png');
...
class LeftroadRoom extends PNGRoom {
  preload() {
    this.shorts = new StaticSprite("shorts", 600,400,'assets/shorts.png');
